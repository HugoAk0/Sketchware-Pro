...
public class BlocksHandler {
	...
	public static void builtInBlocks(ArrayList<HashMap<String, Object>> arrayList) {
		...
		hashMap.put("color", "#4A6CD4");
		hashMap.put("palette", "-1");
		hashMap.put("spec", "%m.edittext setMaxLengthLetters %d");
		arrayList.add(hashMap);
		
		// setLinkTextColor (color)
		hashMap = new HashMap<>();
		hashMap.put("name", "setLinkTextColor");
		hashMap.put("type", " ");
		hashMap.put("code", "%s.setLinkTextColor(%s)");
		hashMap.put("color", "#4A6CD4");
		hashMap.put("palette", "-1");
		hashMap.put("spec", "%m.textview setLinkTextColor %m.color");
		arrayList.add(hashMap);
		
		// setLinksClickable (boolean)
		hashMap = new HashMap<>();
		hashMap.put("name", "setLinksClickable");
		hashMap.put("type", " ");
		hashMap.put("code", "%s.setLinksClickable(%s)");
		hashMap.put("color", "#4A6CD4");
		hashMap.put("palette", "-1");
		hashMap.put("spec", "%m.textview setLinksClickable %b");
		arrayList.add(hashMap);
		
		// setTooltipText (string)
		hashMap = new HashMap<>();
		hashMap.put("name", "setTooltipText");
		hashMap.put("type", " ");
		hashMap.put("code", "%s.setTooltipText(%s)");
		hashMap.put("color", "#4A6CD4");
		hashMap.put("palette", "-1");
		hashMap.put("spec", "%m.view setTooltipText %s");
		arrayList.add(hashMap);
		
		// setAutofillHints (string)
		hashMap = new HashMap<>();
		hashMap.put("name", "setAutofillHints");
		hashMap.put("type", " ");
		hashMap.put("code", "%s.setAutofillHints(%s)");
		hashMap.put("color", "#4A6CD4");
		hashMap.put("palette", "-1");
		hashMap.put("spec", "%m.view setAutofillHints %s");
		arrayList.add(hashMap);
